file:///C:/Users/sti/OneDrive%20-%20Leicom%20AG/Desktop/HTWG/Web_App/backend/app/repositories/UserRepository.scala
...
action parameters:
offset: 1264
uri: file:///C:/Users/sti/OneDrive%20-%20Leicom%20AG/Desktop/HTWG/Web_App/backend/app/repositories/UserRepository.scala
text:
```scala
...
class UsersRepository @Inject() (
  ...
  def updateUser(id: String, user: User): Future[Int] = {
    db.run(users.filter(_.id === id).update(user.copy(id = Some(id))))
  }

  def findUserByFirebaseUid(fireb@@aseUid: String): Future[Option[User]] = {
