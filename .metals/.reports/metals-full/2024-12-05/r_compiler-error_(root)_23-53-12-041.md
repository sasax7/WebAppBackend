file:///C:/Users/sti/OneDrive%20-%20Leicom%20AG/Desktop/HTWG/Web_App/backend/app/controllers/UsersController.scala
...
action parameters:
uri: file:///C:/Users/sti/OneDrive%20-%20Leicom%20AG/Desktop/HTWG/Web_App/backend/app/controllers/UsersController.scala
text:
```scala
package controllers
...
class UsersController @Inject() (
  ...
  def updateUser(firebaseUid: String): Action[JsValue] = Action.async(parse.json) {
    request =>
      request.body
        .validate[User]
        .fold(
          ...
          user => {
            usersRepository.updateUser(firebaseUid, user).map {
              case 0 =>
                NotFound(
                  Json.obj("status" -> "error", "message" -> "User not found")
                )
              case _ =>
                Ok(Json.obj("status" -> "success", "message" -> "User updated"))
            }
          }
        )
  }
