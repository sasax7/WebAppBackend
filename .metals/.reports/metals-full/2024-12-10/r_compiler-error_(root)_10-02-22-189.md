file:///C:/Users/sti/OneDrive%20-%20Leicom%20AG/Desktop/HTWG/Web_App/backend/app/repositories/CandlesRepository.scala
...
action parameters:
uri: file:///C:/Users/sti/OneDrive%20-%20Leicom%20AG/Desktop/HTWG/Web_App/backend/app/repositories/CandlesRepository.scala
text:
```scala
...
class CandlesRepository @Inject() (
  ...
  case Some(existingCandle) =>
    ...
    val mergedHigh = math.max(existingCandle.high, aggregatedCandle.high)
    ...
    val mergedVolume = (existingCandle.volume, aggregatedCandle.volume) match {
    ...
    val mergedCandle = existingCandle.copy(
      open = existingCandle.open,          // or aggregatedCandle.open if you want to refresh the open from this batch
      high = mergedHigh,
      low = mergedLow,
      close = aggregatedCandle.close,      // close from the latest candle we aggregated this time
      volume = mergedVolume
    )
