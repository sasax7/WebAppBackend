...
class StrategyController @Inject() (
  ...
  def getStrategiesByFirebaseUid(firebaseUid: Strin@@g): Action[AnyContent] = Action.async {
    strategyRepository.getStrategiesWithDetailsByFirebaseUid(firebaseUid).map { strategies =>
