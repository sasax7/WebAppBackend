file:///C:/Users/sti/OneDrive%20-%20Leicom%20AG/Desktop/HTWG/Web_App/backend/app/models/State/BacktestContext.scala
...
action parameters:
offset: 416
uri: file:///C:/Users/sti/OneDrive%20-%20Leicom%20AG/Desktop/HTWG/Web_App/backend/app/models/State/BacktestContext.scala
text:
```scala
package state

import models.{Trade, User, Strategy, Candlestick, AddTradeRequest}
...
class BacktestContext(var state: BacktestState) {
  ...
  def updateTimestamp(newTimestamp: Long)(implicit
    ...
    state.updateTimestamp(newTimesta@@mp).map { newState =>
      state = newState
    }
  }

  def addTrade(trade: AddTradeRequest): Unit = {
