...
case class OperationalState(
  ...
  not enough arguments for method apply: (trade: models.AdvancedTrade, stopLosses: Seq[models.StopLoss], takeProfits: Seq[models.TakeProfit], indicators: Seq[models.Indicator], pricePoints: Seq[models.PricePoint], tradeRRs: Seq[models.TradeRR]): models.AdvancedTradeObject in object AdvancedTradeObject.
Unspecified value parameters indicators, pricePoints, tradeRRs.bloop
...
object OperationalState {
  ...
  implicit val operationalStateFormat: OFormat[OperationalState] =
    OFormat(operationalStateReads, operatio@@nalStateWrites)
